...
float: right;
font-size: 16px;"> Date : <?= $date; ?> <?= date("h:i:sa");; ?> <a href="index.php?halaman=logout" class="btn btn-danger square-btn-adjust">Logout</a>
      </div>
    </nav>
    <!-- /. NAV TOP  -->
    <nav class="navbar-default navbar-side" role="navigation">
      <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
          ...
          <li><a href="index.php?halaman=produk"><i class="fa fa-square"></i> Produk</a></li>
          <li><a href="index.php?halaman=kategori"><i class="fa fa-list"></i> Kategori</a></li>
